          ...
          <div class='auto-container'>
            ...
            <div class='filters text-center light'>
              <ul class='filter-tabs filter-btns'>
                <li class='active filter' onClick={() => setState({ ...state, filterKey: 'NONE' })}>
                  <span>Financial</span>
                </li>
                <li class='filter' onClick={() => setState({ ...state, filterKey: 'BANKING' })}>
                  <span>Banking</span>
                </li>
                <li class='filter' onClick={() => setState({ ...state, filterKey: 'INSURANCE' })}>
                  <span>Insurance </span>
                </li>
                <li class='filter' onClick={() => setState({ ...state, filterKey: 'FAMILY' })}>
                  <span>Family</span>
                </li>
                <li class='filter' onClick={() => setState({ ...state, filterKey: 'BUSINESS' })}>
                  <span>Business</span>
                </li>
              </ul>
            </div>
                ...
                <div class='col-lg-4 col-md-6 gallery-block-one' key={image.id}>
                  <div class='inner-box'>
                    ...
                    <div class='caption-title'>
                      <h5>{image.name}</h5>
                      <h3>
                        <Link to={'/#'}>Miranda Hilix Bar</Link>
                      </h3>
